...
export class ProfilePersist extends Component<any, any> {
  ...
  render() {
    ...
    return (
      <Page loading={loading} Root={Column} space={3} padding={3} bgColor="#FFF" flex={1}>
        <Input placeholder="昵称" onChangeText={v => this.handleFieldChange('name', v)} />
        <Input placeholder="邮箱" onChangeText={v => this.handleFieldChange('email', v)} />
